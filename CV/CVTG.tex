...
My work has been published in \textbf{20 peer-reviewed papers} (including 8 as a first author) on macroevolution, macroecology and new statistics methods and implementations.
...
This work has been \textbf{cited in over 1200} % UPDATE
...
\begin{tabular}{ll}
% 2023: & \textit{Sheffield EEB symposium} - Sheffield, UK --- \textit{co-organiser}\\
...
\raggedright\textbf{Peer reviewed} - \href{https://scholar.google.co.uk/citations?user=LA9l9EkAAAAJ&hl=en}{Google Scholar profile: Thomas Guillerme} - 1200 citations, h-index: 17.\\[1.5ex]
