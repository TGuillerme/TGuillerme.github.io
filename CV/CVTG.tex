...
My work has been published in \textbf{24 peer-reviewed papers} (including 11 as a first author) on macroevolution, macroecology and new statistics methods and implementations.
...
This work has been \textbf{cited in over 1500} % UPDATE
...
\begin{tabular}{ll}
20245: & \href{}{Open Research \& FAIR Principles – A Day for Reproducibility and Transparent Workflows}\\
      & Open research workshop \textbf{co-organiser} with Zuzanna Zagrodzka - Sheffield, UK\\
%---------------------------------------
...
\raggedright\textbf{Peer reviewed} - \href{https://scholar.google.co.uk/citations?user=LA9l9EkAAAAJ&hl=en}{Google Scholar profile: Thomas Guillerme} - 1300 citations, h-index: 17.\\[1.5ex]


\begin{tabular}{ll}
22. 2024: & Cardoso P, \textbf{Guillerme T}, Mammola S, Matthews TJ, Rigal F, Graco-Roza C, Stahls G, Carvalho JC.\\
      & Calculating functional diversity metrics using neighbor-joining trees. \textit{Ecography} \href{https://nsojournals.onlinelibrary.wiley.com/doi/10.1111/ecog.07156}{DOI:0.1111/ecog.07156}\\
\end{tabular}
\bigskip
