...
\raggedright\textbf{Peer reviewed} - \href{https://scholar.google.co.uk/citations?user=LA9l9EkAAAAJ&hl=en}{Google Scholar profile: Thomas Guillerme} - 708 citations, h-index: 13, i10-index: 15.\\[1.5ex]
...
%       & character correlation on phylogenetic tree inference. \textit{in review in Systematic Biology} \href{https://doi.org/10.1093/sysbio/syy083}{DOI: 10.1093/sysbio/syy083}\\
% \end{tabular}
% \bigskip

% \begin{tabular}{ll}
% 2019: & \textbf{Guillerme T}, Puttick MN, Marcy AE and Weisbecker V. Shifting spaces: which disparity or dissimilarity metrics best summarise occupancy in multidimensional spaces? \textit{in review in Methods in Ecology and Evolution} \href{https://doi.org/10.1093/sysbio/syy083}{DOI: 10.1093/sysbio/syy083}\\
% \end{tabular}
% \bigskip
