...
\raggedright
\begin{tabular}{ll} 
2020 - present: & Research Associate in \textbf{Gavin Thomas}' group\\
...
My work has been published in \textbf{18 peer-reviewed papers} (including 7 as a first author) on macroevolution, macroecology and new statistics methods and implementations.
...
This work has been \textbf{cited in over 900} % UPDATE
publications with an \textbf{h-index of 15} % UPDATE
...
\raggedright\textbf{Peer reviewed} - \href{https://scholar.google.co.uk/citations?user=LA9l9EkAAAAJ&hl=en}{Google Scholar profile: Thomas Guillerme} - 994 citations, h-index: 15.\\[1.5ex]
