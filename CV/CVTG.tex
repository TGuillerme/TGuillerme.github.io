...
\textbf{Guillerme T.} and Cooper, N. Assessment of cladistic data availability for living mammals. Invited submission for special issue at \textit{Biology Letters}.\\
\smallskip
\textit{Note:} This paper is ready to submit but the deadline for submissions has been extended until December 2015. A preprint is available \href{https://goo.gl/ctd65r}{here (https://goo.gl/ctd65r)}. \\
\smallskip
\textbf{Guillerme T.} and Cooper, N. Tempo and mode in mammalian morphological evolution around the K-Pg boundary. To be submitted to \textit{Evolution} in August 2015.\\[1.5ex]
\bigskip
